...
export const ru: Catalogue = {
  ...
  count: {
    ...
    gwParentUnresolved: {
      one: "называет родительский шлюз, который не удалось разрешить — наборы слушателей не прочитаны.",
      few: "называют родительский шлюз, который не удалось разрешить — наборы слушателей не прочитаны.",
      many: "называют родительский шлюз, который не удалось разрешить — наборы слушателей не прочитаны.",
      other:
        "называют родительский шлюз, который не удалось разрешить — наборы слушателей не прочитаны.",
    },
    gwMeshAlsoNames: {
