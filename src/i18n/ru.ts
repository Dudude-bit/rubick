...
export const ru: Catalogue = {
  ...
  share: {
    ...
    target: "Цель",
    noTargets:
      "Целей публикации пока нет. Отчёт сохраняется файлом, пока вы не добавите цель в Settings › Sharing.",
    targetNoKey:
      "У этой цели ещё нет ключа; добавьте его в Settings › Sharing.",
    publicWarning:
