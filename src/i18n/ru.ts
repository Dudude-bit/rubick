...
export const ru: Catalogue = {
  ...
  share: {
    ...
    reportTitle: "Расследование",
    captured: "снято",
    openInRubick: "Открыть в Rubick",
    linkFallback: "Rubick на этой машине нет? Вставьте это в его поиск:",
    sectionVerdict: "Скорее всего",
    noVerdict: "приложению нечего поставить первым",
    sectionFacts: "Факты",
    sectionChain: "Цепочка трафика на момент снимка",
    ...
    previousRun: "предыдущий запуск",
    notLookedAt: "не смотрели",
    kindNotLookedAt: "{kind}: не смотрели, когда рисовали цепочку",
    hopMissing: "не существует",
    journalEmpty:
  ...
  alerts: {
    ...
    firingNow: {
      one: "{n} алерт горит в {rules} объектах правил",
      few: "{n} алерта горят в {rules} объектах правил",
      many: "{n} алертов горят в {rules} объектах правил",
      other: "{n} алертов горят в {rules} объектах правил",
    },
    quietNow: {
    ...
    rules: "Правила",
    verdictFiring: {
      one: "{n} алерт горит из {rules} правил.",
      few: "{n} алерта горят из {rules} правил.",
      many: "{n} алертов горят из {rules} правил.",
      other: "{n} алертов горят из {rules} правил.",
    },
    verdictNotPickedUp:
    ...
    verdictPending: {
      ...
      few: "{n} алерта ждут из {rules} правил, ещё не прошли свой for.",
      many: "{n} алертов ждут из {rules} правил, ещё не прошли свой for.",
      other: "{n} алертов ждут из {rules} правил, ещё не прошли свой for.",
    },
