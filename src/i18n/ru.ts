...
export const ru: Catalogue = {
  ...
  columns: {
    ...
    listenerHostname: "Хост слушателя {host}",
    whoInfra: "инфра",
  ...
  action: {
    ...
    undo: "Отменить",
    openOnSiteShort: "Открыть в {site}",
    valueNoun: "значение",
    ...
    drainFailed: "Освобождение сломалось.",
    ...
    startFreezeTitle: "Заморозить этот интервал",
    stopFreezeTitle: "Разморозить этот интервал",
    thawFrozen: "разморозить",
    frozenNote:
    ...
    viewRaw: "Как есть",
    viewRawHint: "Строка целиком, без кодов цвета",
    repeats: "Повторы",
    collapseRepeatsHint:
    ...
    cronRunFailed: "Не удалось запустить",
  ...
  checks: {
    ...
    ranInContainer: "в собственном контейнере пода",
  ...
  hints: {
    ...
    copiedForAgent: {
      one: "Скопирован {n} символ. Прочитайте перед тем, как вставлять: строки лога — это то, что напечатал контейнер.",
      few: "Скопировано {n} символа. Прочитайте перед тем, как вставлять: строки лога — это то, что напечатал контейнер.",
      many: "Скопировано {n} символов. Прочитайте перед тем, как вставлять: строки лога — это то, что напечатал контейнер.",
      other:
        "Скопировано {n} символа. Прочитайте перед тем, как вставлять: строки лога — это то, что напечатал контейнер.",
    },
  ...
  services: {
    ...
    pinsFull: {
      one: "В этом кластере уже закреплён {n} сервис",
      few: "В этом кластере уже закреплено {n} сервиса",
      many: "В этом кластере уже закреплено {n} сервисов",
      other: "В этом кластере уже закреплено {n} сервиса",
    },
    pinsFullHint:
  ...
  share: {
    ...
    published: "Опубликовано, версия {n}",
    publishing: "Публикую…",
    publishFailed: "Не удалось опубликовать",
    copyLink: "Скопировать ссылку",
    saveInstead: "Вместо этого сохранить как HTML",
    target: "Цель",
    noTargets:
      "Целей публикации пока нет. Отчёт сохраняется файлом, пока вы не добавите цель в «Настройки › Публикация».",
    targetNoKey:
      "У этой цели ещё нет ключа; добавьте его в «Настройки › Публикация».",
    publicWarning:
      "Прочитать сможет любой, у кого есть ссылка, и сам {host}. В отчёте имена вашего кластера, образы и строки логов.",
    publicAcknowledge: "Я понимаю, что уходит с этой машины",
    addTarget: "Добавить цель",
    targetLabel: "Название",
    targetUrl: "Адрес API",
    targetKind: "Тип",
    targetKindPostplan: "postplan",
    targetKindGeneric: "Обычный endpoint",
    targetPublic: "Прочитать сможет любой со ссылкой",
    targetPublicHint:
      "Включите для сервиса, открытого в интернет. Такая цель рисуется зарезервированным красным и каждый раз просит подтверждение.",
    targetKey: "Ключ API",
    ...
    verifyFailed: "Цель не приняла ключ",
    removeTarget: "Удалить",
    targetsEmpty: "Целей пока нет. Отчёты сохраняются файлами.",
    share: "Поделиться",
    shareThis: "Поделиться расследованием",
    captured: "Снято",
    openInRubick: "Открыть в Rubick",
    linkFallback: "или вставьте ссылку в поиск Rubick:",
    sectionVerdict: "Скорее всего",
    sectionTraffic: "Как до него доходит трафик",
    sectionConnections: "С чем он связан",
    ...
    kickerScreen: "Снимок экрана",
    created: "Создан",
    stillReading: "На момент отчёта ещё читалось.",
    shareScreen: "Поделиться этим экраном",
    rowsMore: {
      one: "Ещё {n} строка есть в приложении.",
      few: "Ещё {n} строки есть в приложении.",
      many: "Ещё {n} строк есть в приложении.",
      other: "Ещё {n} строки есть в приложении.",
    },
    atCapture: "на момент снимка",
    initContainer: "init",
    kindNotLookedAt: "{kind}: не смотрели, когда читали связи",
    notReadCount: {
      one: "{n} вещь прочитать не удалось. Список в конце.",
      few: "{n} вещи прочитать не удалось. Список в конце.",
      many: "{n} вещей прочитать не удалось. Список в конце.",
      other: "{n} вещи прочитать не удалось. Список в конце.",
    },
    allRead: "Всё, что названо в отчёте, прочитано.",
    includeLogs: "Добавить строки лога",
    logsShown: {
      one: "{n} строка, как её показывала вкладка Logs",
      few: "{n} строки, как их показывала вкладка Logs",
      many: "{n} строк, как их показывала вкладка Logs",
      other: "{n} строки, как их показывала вкладка Logs",
    },
    logsTail: {
      one: "последняя {n} из {total} строк, что показывала вкладка Logs",
      few: "последние {n} из {total} строк, что показывала вкладка Logs",
      many: "последние {n} из {total} строк, что показывала вкладка Logs",
      other: "последние {n} из {total} строк, что показывала вкладка Logs",
    },
    logsFromHint: "строки, которые прочитала «Скорее всего» для вердикта",
    logsNotOpened:
      "Нет: вкладка Logs не была открыта на этой странице, когда делался отчёт.",
    logsLeftOut:
      "Тот, кто поделился отчётом, не стал добавлять в него строки лога.",
    openLink: "Открыть {url}",
    journalEmpty:
      "Приложение не следило за этим кластером, поэтому изменений не записало.",
    madeBy: "Сделано в Rubick",
    noSecrets: "Значения секретов в этот файл не попадают никогда.",
    saveHtml: "Сохранить как HTML",
    saved: "Сохранено в {path}",
    saveFailed: "Не удалось записать файл",
    preview: "Что попадёт в файл",
    whatItCarries:
      "Один самодостаточный HTML с тем, что показывает эта страница: статус, всё, на чём он основан, и то, что прочитать не удалось, в том виде, как это рисует Rubick. Ни скриптов, ни запросов при открытии.",
    charactersLong: {
      one: "{n} символ",
      few: "{n} символа",
      many: "{n} символов",
    ...
    trfSectionRoutes: "Маршруты",
    wlAvailable: "Доступно",
    wlParallelism: "Параллелизм",
    wlFailed: "Неудачные",
    wlUpToDate: "Актуально",
    notWrittenYet: "ещё не записано",
    cmNotAfter: "Истекает",
    cmIssuer: "Издатель",
    cmDnsNames: "DNS-имена",
    cmSecret: "Secret",
    cmIssuerType: "Тип",
    cmIssuerTypeUnknown: "не один из известных типов издателя",
    cmChallengeType: "Тип challenge",
    argoDestination: "Назначение",
    argoSource: "Источник",
    argoGeneratedBy: "Сгенерировано",
    argoResources: "Ресурсы",
    ...
    clKeyColumn: "Ключ",
    clSizeColumn: "Размер",
    clEffectColumn: "Эффект",
    clDataUnread: "Не удалось прочитать данные: {reason}",
    netListenerConditions: "Условия слушателей",
    netPolicyTypes: "Типы политики",
    fluxSource: "Источник",
    fluxApplied: "Применено",
    fluxInterval: "Интервал",
    fluxMessage: "Сообщение",
    fluxRef: "Отслеживает",
    fluxArtifact: "Артефакт",
    scrNotReadable: "Прочитать не удалось",
    promSelector: "Селектор",
    promNamespaces: "Пространства имён",
    promEndpoints: "Эндпоинты",
    promPath: "Путь",
    promVersion: "Версия",
    promRetention: "Хранение",
    promServiceMonitorSelector: "Селектор ServiceMonitor",
    promPodMonitorSelector: "Селектор PodMonitor",
    promGroup: "Группа",
    promRule: "Правило",
    promExpr: "Выражение",
    istioGateways: "Gateway",
    istioEveryRequest: "любой запрос",
    istioProtocol: "Протокол",
    istioDestination: "Назначение",
    istioSectionRoutes: "Маршруты",
    istioSubsets: "Подмножества",
    istioModeUnset: "не задан, наследуется от mesh по умолчанию",
    istioMtlsMode: "Режим mTLS",
    istioAction: "Действие",
    istioRuleCount: "Правила",
    scrFilters: "Фильтры",
    cnpgPrimary: "Основной",
    cnpgVersion: "Версия PostgreSQL",
    cnpgArchiving: "Непрерывное архивирование",
    cnpgInstances: "Инстансы",
    cnpgRole: "Роль",
    cnpgMethod: "Метод",
    cnpgLastScheduled: "Последний запуск по расписанию",
    cnpgCluster: "Кластер",
    cnpgPoolMode: "Режим пула",
    scrWatched: "Слежение",
    scrGapsInWindow: {
      one: "{n} промежуток в этом окне не отслеживался.",
      few: "{n} промежутка в этом окне не отслеживались.",
      many: "{n} промежутков в этом окне не отслеживались.",
      other: "{n} промежутка в этом окне не отслеживались.",
    },
    scyllaMembers: "Члены",
    scyllaVersion: "Версия",
    ...
    intAuthNone: "без аутентификации",
    ciliumEveryEndpoint: "любой эндпоинт в области действия",
    ciliumExpressions: {
    ...
    ciliumRejected: "отклонена",
    ciliumSelects: "Выбирает",
    ciliumRules: "Правила",
    ciliumIngressEgress: "{ingress} ingress, {egress} egress",
    ciliumDenies: "Deny-правила",
    ciliumLeavesCluster: "Выходит за пределы кластера",
    gceHealthCheck: "Проверка здоровья",
    gceApplies: "Применяет",
    gceDomains: "Домены",
    awsNoFailure: "контроллер ничего не отметил",
    awsTargetGroup: "Target group",
    awsTargets: "Targets",
    scrBasis: "Основа",
    scrSilent: "Нет рядов",
    azureType: "Тип",
    azureResource: "Ресурс Azure",
  ...
  slow: {
    panel: "Почему медленно",
    title: "Почему медленно",
    hint: "Что приложение измерило за последнюю минуту, без рекордера.",
    stalls: {
      one: "{n} стоп",
      few: "{n} стопа",
      many: "{n} стопов",
    ...
    stallsLabel: "Стопы",
    stallsValue: {
      one: "{n} стоп, самый долгий {longest} мс",
      few: "{n} стопа, самый долгий {longest} мс",
      many: "{n} стопов, самый долгий {longest} мс",
      other: "{n} стопов, самый долгий {longest} мс",
    },
    sourceLongTask:
      "Стоп это главный поток, занятый 50 мс и дольше, по наблюдателю long task самого webview.",
    sourceFrameGap:
      "Стоп это кадр, опоздавший на 50 мс и больше; у этого webview нет наблюдателя long task, поэтому считаются опоздавшие кадры.",
    ...
    listsWhy:
      "Каждая пачка watch фильтруется и сортируется по всему списку, а поиск перечитывает каждую строку.",
    answerLabel: "Самый большой ответ",
    answerRows: {
      one: "{n} строка от {command}",
      few: "{n} строки от {command}",
      many: "{n} строк от {command}",
      other: "{n} строк от {command}",
    },
    noBigAnswer:
      "Ни одного ответа из тех, что здесь считаются, длиннее тысячи строк.",
    answerWhy:
      "Большой ответ разбирается в главном потоке до того, как что-то можно нарисовать.",
    whatToDo:
      "Сузь область namespace или поиск: список и его ответы уменьшаются вместе с ними. Для времени по командам и рендерам включи рекордер.",
    notCounted:
  ...
  alerts: {
    tabAlerts: "Алерты",
    pageHint:
      "Каждый PrometheusRule: какой Prometheus его подхватывает, загрузил ли он правила и что горит прямо сейчас.",
    ...
    objects: {
      one: "{n} объект правил",
      few: "{n} объекта правил",
      many: "{n} объектов правил",
      other: "{n} объектов правил",
    },
    firingNow: {
      one: "{n} алерт горит {where}",
      few: "{n} алерта горят {where}",
      many: "{n} алертов горят {where}",
      other: "{n} алертов горят {where}",
    },
    inRuleObjects: {
      one: "в {n} объекте правил",
      few: "в {n} объектах правил",
      many: "в {n} объектах правил",
      other: "в {n} объектах правил",
    },
    quietNow: {
      one: "{n} объект правил, ничего не горит",
      few: "{n} объекта правил, ничего не горит",
      many: "{n} объектов правил, ничего не горит",
      other: "{n} объектов правил, ничего не горит",
    },
    brokenCount: {
      one: "{n} сломан",
      few: "{n} сломаны",
    ...
    notConnected:
      "К этому кластеру не подключён Prometheus. Подхват прочитан из объектов; загружены ли правила и горят ли, не проверено.",
    unanswered:
      "Подключённый Prometheus не ответил про свои правила: {reason}. Горит ли что-то, неизвестно, а не пусто.",
    rulesLoaded: {
      one: "{n} алертящее правило загружено на подключённом Prometheus",
      few: "{n} алертящих правила загружено на подключённом Prometheus",
      many: "{n} алертящих правил загружено на подключённом Prometheus",
      other: "{n} алертящих правил загружено на подключённом Prometheus",
    },
    groupFiring: "Горит",
    groupBroken: "Сломано",
    groupPending: "Ждёт",
    ...
    rowFiring: {
      one: "горит {n} алерт",
      few: "горят {n} алерта",
      many: "горят {n} алертов",
      other: "горят {n} алерта",
    },
    rowPending: {
      one: "ждёт {n} алерт",
      few: "ждут {n} алерта",
    ...
    rowPartlyLoaded: {
      one: "{n} правило не загружено",
      few: "{n} правила не загружены",
      many: "{n} правил не загружены",
      other: "{n} правила не загружены",
    },
    aboutUnread:
      "Не удалось прочитать, горит ли что-то про этот объект: {reason}",
    aboutUnreachable: "Подключённый Prometheus не ответил: {reason}",
    markUnchecked: {
      one: "{n} объект правил не проверен",
      few: "{n} объекта правил не проверены",
      many: "{n} объектов правил не проверены",
      other: "{n} объекта правил не проверены",
    },
    markBroken: {
      one: "{n} объект правил требует внимания",
      few: "{n} объекта правил требуют внимания",
      many: "{n} объектов правил требуют внимания",
      other: "{n} объекта правил требуют внимания",
    },
    ...
    recordingCount: {
      one: "{n} recording-правило",
      few: "{n} recording-правила",
      many: "{n} recording-правил",
      other: "{n} recording-правил",
    },
    ...
    loadedOf: "{n} из {total}",
    notLoaded:
      "У подключённого Prometheus нет файла правил с именем этого объекта: оператор его не записал или записал для другого Prometheus, не того, что подключён.",
    chipFile: "файл",
    rules: "Правила",
    verdictFiring: {
      one: "{n} алерт горит {from}.",
      few: "{n} алерта горят {from}.",
      many: "{n} алертов горят {from}.",
      other: "{n} алертов горят {from}.",
    },
    fromRules: {
      one: "из {n} правила",
      few: "из {n} правил",
    ...
    verdictNotPickedUp:
      "Ни один Prometheus его не подхватывает, ни одно из его правил не вычисляется.",
    verdictNotLoaded: "Подхвачен, но подключённый Prometheus его не загрузил.",
    verdictPartlyLoaded: {
      one: "{n} правила этого объекта нет в подключённом Prometheus.",
      few: "{n} правил этого объекта нет в подключённом Prometheus.",
    ...
    verdictPending: {
      one: "{n} алерт ждёт {from}, ещё не прошёл свой for.",
      few: "{n} алерта ждут {from}, ещё не прошли свой for.",
      many: "{n} алертов ждут {from}, ещё не прошли свой for.",
      other: "{n} алертов ждут {from}, ещё не прошли свой for.",
    },
    verdictNotChecked: "Подхвачен. Загружен ли и горит ли, не проверено.",
    verdictQuiet: {
      one: "{n} правило загружено и вычисляется, ничего не горит.",
      few: "{n} правила загружены и вычисляются, ничего не горит.",
      many: "{n} правил загружены и вычисляются, ничего не горит.",
      other: "{n} правил загружены и вычисляются, ничего не горит.",
    },
    notInPrometheus: "нет в Prometheus",
    since: "с {time} · {ago}",
    moreAlerts: {
      one: "ещё {n} алерт",
      few: "ещё {n} алерта",
    ...
    aboutFiring: {
      one: "{n} алерт горит про этот объект",
      few: "{n} алерта горят про этот объект",
      many: "{n} алертов горят про этот объект",
      other: "{n} алертов горят про этот объект",
    },
    aboutPending: {
      one: "{n} алерт ждёт про этот объект",
      few: "{n} алерта ждут про этот объект",
      many: "{n} алертов ждут про этот объект",
      other: "{n} алертов ждут про этот объект",
    },
    openAlerts: "Все алерты",
    backToSearch: "назад к поиску",
    readAsAnAlert: "Прочитано как алерт",
    unnamedAlert: "алерт без имени",
    formatAlertmanager: "Alertmanager",
    formatSubject: "Заголовок Alertmanager",
    ...
    ignored: "Пропущено",
    notNamed: "не назван",
    notDated: "алерт не называет времени, поэтому окно открывать не по чему",
    nothingSaysAKind: "в этом тексте ничто не называет kind",
    ...
    namesSeveral: {
      ...
      few: "названо {n} объекта. Какой нужен?",
      many: "названо {n} объектов. Какой нужен?",
      other: "названо {n} объекта. Какой нужен?",
    },
    theSubject: "о чём алерт",
    alsoNamed: "тоже упомянут",
    whyNamedExactly: "назван точно",
    whyNameAppears: "слово из алерта есть в этом имени",
    whyInSourceHost: "его имя есть в хосте Source",
    whyYours: "ваш",
    fromTheSourceHost: "догадка по хосту Source",
    byShape: "по форме",
    guessedFromShape:
    ...
    grouped: {
      ...
      many: "в сообщении {n} алертов, и поля ниже — первого из них",
      other: "в сообщении {n} алерта, и поля ниже — первого из них",
    },
    ...
    readJustNow: "Что приложение прочитало только что:",
    readNoStatus: "прочитан; у этого вида нет состояния",
    stillReading: "Приложение ещё читает.",
    objectUnread: "Приложение не смогло прочитать: {error}",
    alertWords:
      "alert alertmanager pagerduty grafana datadog paste incident алерт инцидент вставить",
  },
  ...
  vendor: {
    ...
    prometheusGives:
      "историю нагрузки, заполненность томов и трафик подов и рабочих нагрузок по адресу; каждый ServiceMonitor и PodMonitor с тем, кого он выбирает, какой Prometheus его подхватывает и скрейпится ли он на самом деле; каждый PrometheusRule с тем, загрузил ли его подключённый Prometheus и что по нему горит, и алерты про сам объект на его странице",
    traefikGives:
  ...
  readings: {
    ...
    lokiPageLimit: {
      one: "до {n} строки на страницу",
      few: "до {n} строк на страницу",
    ...
    hpaSeveralTitle: {
      ...
      many: "{n} автомасштабировщиков",
      other: "{n} автомасштабировщика",
    },
    hpaSeveralHead: {
      one: "Эту нагрузку заявляет {n} автомасштабировщик.",
      few: "Эту нагрузку заявляют {n} автомасштабировщика.",
      many: "Эту нагрузку заявляют {n} автомасштабировщиков.",
      other: "Эту нагрузку заявляют {n} автомасштабировщика.",
    },
    hpaSeveralDetail:
  ...
  cluster: {
    ...
    namespaceLimitFull: {
      ...
      many: "{n} пространств имён — больше одно окно не читает.",
      other: "{n} пространства имён — больше одно окно не читает.",
    },
    namespaceScopeCount:
  ...
  settings: {
    ...
    shellEnvImported: {
      one: "Прочитано из {shell}, запущенного как интерактивный login-shell, как это делает терминал: изменена {n} переменная, снято {removed}, PATH объединён.",
      few: "Прочитано из {shell}, запущенного как интерактивный login-shell, как это делает терминал: изменены {n} переменные, снято {removed}, PATH объединён.",
      many: "Прочитано из {shell}, запущенного как интерактивный login-shell, как это делает терминал: изменено {n} переменных, снято {removed}, PATH объединён.",
      other:
        "Прочитано из {shell}, запущенного как интерактивный login-shell, как это делает терминал: изменено {n} переменной, снято {removed}, PATH объединён.",
    },
    shellEnvTimedOut:
      "{shell} не напечатал своё окружение за {seconds} с, поэтому процесс остался с окружением, с которым был запущен, а PATH ниже составлен из известных каталогов. Обычная причина: медленный .zshrc или .bashrc.",
    shellEnvCouldNotStart:
      "{shell} не удалось запустить ({error}), поэтому процесс остался с окружением, с которым был запущен, а PATH ниже составлен из известных каталогов.",
    shellEnvNoAnswer:
      "{shell} завершился с кодом {exit}, не напечатав окружение, поэтому процесс остался с окружением, с которым был запущен, а PATH ниже составлен из известных каталогов.",
    shellFindingTitle:
      "Login-оболочка не ответила, поэтому путь поиска — догадка",
    shellFindingConsequence:
      "Пока она не ответит, PATH — это список известных каталогов без того, что добавляет ваш профиль, поэтому плагин или инструмент, помеченный ниже как отсутствующий, может быть установлен в каталоге, которого приложение не увидело.",
    shellEnvNotRecorded:
      "Приложение не записало, спрашивало ли оно login-оболочку, поэтому путь поиска ниже — только известные каталоги, без того, что добавляет ваш профиль.",
    shellEnvNotAsked:
      "На этой платформе не спрашивается: Windows передаёт приложению окружение из системных настроек. Того, что задано только в профиле PowerShell, там нет.",
  ...
  empty: {
    ...
    noStoriesInWindowCapped: {
      one: "Ни одной истории в {scope} за последние {range} — из последнего {n} прочитанного события. Всё, что старше, в этот ответ не попало.",
      few: "Ни одной истории в {scope} за последние {range} — из последних {n} прочитанных событий. Всё, что старше, в этот ответ не попало.",
      many: "Ни одной истории в {scope} за последние {range} — из последних {n} прочитанных событий. Всё, что старше, в этот ответ не попало.",
      other:
    ...
    noEventsMatchInWindow: {
      one: "Среди последнего {n} события в {scope} по запросу «{query}» ничего нет. Более старые не читались — увеличьте лимит, чтобы искать глубже.",
      few: "Среди последних {n} событий в {scope} по запросу «{query}» ничего нет. Более старые не читались — увеличьте лимит, чтобы искать глубже.",
      many: "Среди последних {n} событий в {scope} по запросу «{query}» ничего нет. Более старые не читались — увеличьте лимит, чтобы искать глубже.",
      other:
    ...
    nodeResourcesNote:
      "capacity это машина, allocatable это что предлагает kubelet, requested это что планировщик уже пообещал",
    nodeBudgetQuestion:
      "Не удалось прочитать, что зарезервировано на этом узле.",
    nodeBudgetFailed: "Запрошено и лимит неизвестны: {error}",
    nodeBudgetRefused: {
      one: "Запрошено и лимит неизвестны: список подов в {n} пространстве имён отклонён ({namespaces}). Сумма по остальным была бы меньшим числом, выданным за целое, поэтому её нет.",
      few: "Запрошено и лимит неизвестны: список подов в {n} пространствах имён отклонён ({namespaces}). Сумма по остальным была бы меньшим числом, выданным за целое, поэтому её нет.",
      many: "Запрошено и лимит неизвестны: список подов в {n} пространствах имён отклонён ({namespaces}). Сумма по остальным была бы меньшим числом, выданным за целое, поэтому её нет.",
      other:
    ...
    noPodsOnNode: "На этом узле нет подов",
    ...
    drainKeepsAsking:
      "Освобождение перевезёт что сможет и продолжит спрашивать про остальных, как это делает kubectl. Ничего не удаляется ради обхода бюджета, и остановить можно в любой момент.",
    ...
    nodesFromPods:
      "Сумма подов каждого узла: {vendor} не хранит серий по узлу целиком, поэтому kubelet, системные демоны и ОС не учтены, и реальная загрузка выше.",
    nodesSilentTitle: "Ни у одного узла нет серий CPU или памяти в {vendor}",
    nodesSilentAsked:
      "Запрошены {cpu} и {memory}: сначала корневой cgroup каждого узла ({root}), затем сумма контейнеров его подов. Оба ответа пустые.",
    nodesSilentReason:
      "Скорее всего, {vendor} не хранит серии cAdvisor: эндпоинт kubelet /metrics/cadvisor никто не опрашивает, или relabelling их отбрасывает.",
    nodesSilentCheck:
      "Проверьте, опрашивается ли эндпоинт cAdvisor у kubelet, в {monitors}.",
    ...
    promNotWatchingBody: {
      one: "Из {n} узла этого кластера в нём нет ни одного. Адрес отвечает на PromQL — это всё, что доказала проверка подключения, — а все графики истории и объёмов, которые приложение из него берёт, относятся к чужому кластеру.",
      few: "Ни один из {n} узлов этого кластера в нём не встречается. Адрес отвечает на PromQL — это всё, что доказала проверка подключения, — а все графики истории и объёмов, которые приложение из него берёт, относятся к чужому кластеру.",
      many: "Ни один из {n} узлов этого кластера в нём не встречается. Адрес отвечает на PromQL — это всё, что доказала проверка подключения, — а все графики истории и объёмов, которые приложение из него берёт, относятся к чужому кластеру.",
      other:
    ...
    diffUnavailable:
      "Не удалось сравнить. На то, что сделает «Применить», это не влияет — не получилось именно сравнение.",
    ...
    bufferHoldsKeptAndNewest:
      "Буфер хранит замороженный интервал и последние {count} вокруг него; остального здесь больше нет.",
    linesDroppedAroundKeptAxis:
      "Строки удалены вокруг замороженного интервала — лог отсюда идёт с разрывом.",
    ...
    gwNoRouteStatusSay: "Контроллер не вынес вердикт об этом маршруте",
    gwNoRouteStatusShort: "нет статуса маршрута",
    gwNoRouteStatusTitle: "Об этом маршруте ничего не записано",
    gwNoRouteStatusBody:
      "Класс этого Gateway заявлен контроллером, и сам Gateway он не отверг — значит контроллер работает и просто не записал статус для этого маршрута. Некоторые реализации до сих пор не пишут его для alpha-видов маршрутов. Идёт ли по маршруту трафик, отсюда не прочитать, а это не то же самое, что сказать, что не идёт.",
    gwNoStatusPeek:
      "Ни один контроллер не записал статус — этот маршрут ничего не обслуживает.",
    gwAcceptedPending: "Контроллер взял этого родителя и ещё не решил",
  ...
  shortcuts: {
    ...
    downloadFile: "Скачать открытый файл",
    ...
    tabLogs: "Вкладка «Логи»",
    tabYaml: "Вкладка YAML",
    tabEvents: "Вкладка «События»",
    nextTab: "Следующая вкладка",
    previousTab: "Предыдущая вкладка",
    newTab: "Новая вкладка",
    closeTab: "Закрыть вкладку",
    nthTab: "Вкладка по номеру, 9 это последняя",
    rowMove: "Переход между строками",
  ...
  count: {
    ...
    ofApplications: {
      one: "из {n} приложения",
      few: "из {n} приложений",
      many: "из {n} приложений",
      other: "из {n} приложений",
    },
    binaryValues: {
      one: "{n} двоичное",
      few: "{n} двоичных",
    ...
    staticPodsStay: {
      one: "{n} статический под остаётся — он принадлежит узлу, а не кластеру.",
      few: "{n} статических пода остаются — они принадлежат узлу, а не кластеру.",
      many: "{n} статических подов остаются — они принадлежат узлу, а не кластеру.",
      other:
        "{n} статических пода остаются — они принадлежат узлу, а не кластеру.",
    },
    podsHadAlreadyLeft: {
    ...
    frozenLines: {
      one: "{count} замороженная строка",
      few: "{count} замороженные строки",
      many: "{count} замороженных строк",
    ...
    densitySummary: {
      ...
      many: "Плотность лога во времени: {n} срезов по {step}, с {from} до {to}.",
      other:
    ...
    busiestSlice: {
      ...
      many: "Самый плотный срез {clock}: {lines} строк.",
    ...
    linesDroppedAroundKept: {
      one: "Вокруг замороженного интервала отброшена {count} строка.",
      few: "Вокруг замороженного интервала отброшено {count} строки.",
      many: "Вокруг замороженного интервала отброшено {count} строк.",
      other: "Вокруг замороженного интервала отброшено {count} строк.",
    },
    rowsStandFor: {
    ...
    gwParentUnresolved: {
      one: "называет родительский шлюз, который не удалось разрешить до Gateway.",
      few: "называют родительский шлюз, который не удалось разрешить до Gateway.",
      many: "называют родительский шлюз, который не удалось разрешить до Gateway.",
      other:
        "называют родительский шлюз, который не удалось разрешить до Gateway.",
    },
    gwMeshAlsoNames: {
