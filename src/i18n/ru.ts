...
export const ru: Catalogue = {
  ...
  shortcuts: {
    ...
    hint: "Нажмите ? где угодно вне текстового поля, чтобы открыть этот список.",
    groupEverywhere: "Везде",
    groupTabs: "Вкладки",
    groupPalette: "Поиск",
    groupLists: "Списки",
    groupPeek: "Панель просмотра",
    groupFiles: "Вкладка файлов",
    groupLogs: "Логи",
    search: "Искать объекты, страницы и кластеры",
    settings: "Открыть настройки",
    copyLink: "Скопировать ссылку на это место",
    thisList: "Этот список",
    closeDialog: "Закрыть диалог или панель",
    newTab: "Новая вкладка на этом кластере",
    closeTab: "Закрыть вкладку",
    cycleTabs: "Следующая или предыдущая вкладка",
    tabByNumber: "Вкладка по номеру, 9 это последняя",
    moveSelection: "Двигать выбор",
    openHit: "Открыть выбранное",
    openHitBehind: "Открыть во вкладке позади этой",
    completeCluster: "Дописать имя кластера после !",
    dropScope: "Убрать область кластера при пустом поле",
    moveRow: "Двигаться по строкам",
    firstLastRow: "Первая или последняя строка",
    openRow: "Открыть страницу строки",
    openRowBehind: "Открыть во вкладке позади этой",
    openRowFront: "Открыть во вкладке впереди",
    peekFullPage: "Открыть полную страницу",
    peekResize: "Изменить ширину панели, на её краю",
    peekClose: "Закрыть панель",
    openEntry: "Открыть файл или папку",
    upOneLevel: "На папку выше",
    download: "Скачать файл",
    soloContainer: "Показать строки одного контейнера",
    allContainers: "Снова показать все контейнеры",
    selectRendered: "Выделить строки на экране",
    stripMove: "Двигаться по полосе времени",
    stripRange: "Выделить промежуток на полосе",
    stripJump: "Прокрутить лог к срезу полосы",
    stripClear: "Снять выделение",
    hintKeys: "клавиши",
  },
