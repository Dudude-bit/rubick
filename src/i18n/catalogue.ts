...
export const en = {
  ...
  shortcuts: {
    ...
    hint: "Press ? anywhere outside a text field to open this list.",
    groupEverywhere: "Everywhere",
    groupTabs: "Tabs",
    groupPalette: "Search",
    groupLists: "Lists",
    groupPeek: "Peek panel",
    groupFiles: "Files tab",
    groupLogs: "Logs",
    search: "Search objects, pages and clusters",
    settings: "Open Settings",
    copyLink: "Copy a link to where you are",
    thisList: "This list",
    closeDialog: "Close a dialog or a panel",
    newTab: "New tab on this cluster",
    closeTab: "Close the tab",
    cycleTabs: "Next or previous tab",
    tabByNumber: "Tab by number, 9 is the last",
    moveSelection: "Move the selection",
    openHit: "Open the selected hit",
    openHitBehind: "Open it in a tab behind this one",
    completeCluster: "Complete the cluster name after a !",
    dropScope: "Drop the cluster scope when the field is empty",
    moveRow: "Move between rows",
    firstLastRow: "First or last row",
    openRow: "Open the row's page",
    openRowBehind: "Open it in a tab behind this one",
    openRowFront: "Open it in a tab in front",
    peekFullPage: "Open the full page",
    peekResize: "Resize the panel, on its edge",
    peekClose: "Close the panel",
    openEntry: "Open the file or folder",
    upOneLevel: "Up one folder",
    download: "Download the file",
    soloContainer: "Show one container's lines only",
    allContainers: "Show every container again",
    selectRendered: "Select the lines on screen",
    stripMove: "Move along the time strip",
    stripRange: "Select a time range on the strip",
    stripJump: "Scroll the log to the strip's slice",
    stripClear: "Clear the range",
    hintKeys: "keys",
  },
