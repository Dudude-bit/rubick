/**
 * The body of the peek panel, loaded apart from the shell that mounts it:
 * logs, traffic, debug and port-forward are most of what the window would
 * otherwise load before it can draw its first frame.
 */
